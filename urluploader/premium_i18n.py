...
TEXTS: dict[str, dict[str, str]] = {
    "pt": {
        ...
        "menu_download": "<b>Baixar por link</b>\n<i>Envie uma URL direta ou link social suportado.</i>",
        "mp3_usage": "Envie assim: /mp3 https://link-do-video",
        ...
        "crunchyroll_auth_required": "A Crunchyroll exigiu login para esse link. Configure YTDLP_COOKIES_CRUNCHYROLL com cookies validos da sua conta.",
        "drm_protected": "Esse video usa DRM. Cookies liberam o login, mas o yt-dlp nao baixa midia protegida por DRM.",
    ...
    "en": {
        ...
        "mp3_usage": "Send it like this: /mp3 https://video-link",
        ...
        "crunchyroll_auth_required": "Crunchyroll required login for this link. Configure YTDLP_COOKIES_CRUNCHYROLL with valid cookies from your account.",
        "drm_protected": "This video uses DRM. Cookies unlock login, but yt-dlp cannot download DRM-protected media.",
    ...
    "es": {
        ...
        "mp3_usage": "Envialo asi: /mp3 https://enlace-del-video",
        ...
        "crunchyroll_auth_required": "Crunchyroll pidió inicio de sesión para este enlace. Configura YTDLP_COOKIES_CRUNCHYROLL con cookies válidas de tu cuenta.",
        "drm_protected": "Este video usa DRM. Las cookies habilitan el login, pero yt-dlp no descarga medios protegidos por DRM.",
...
TEXTS["es"].update(
    {
        ...
        "facebook_auth_required": "Facebook pidi\u00f3 inicio de sesi\u00f3n para este enlace. Prueba una URL p\u00fablica directa o configura cookies del navegador para yt-dlp.",
        "crunchyroll_auth_required": "Crunchyroll pidi\u00f3 inicio de sesi\u00f3n para este enlace. Configura YTDLP_COOKIES_CRUNCHYROLL con cookies validas de tu cuenta.",
        "drm_protected": "Este video usa DRM. Las cookies habilitan el login, pero yt-dlp no descarga medios protegidos por DRM.",
        "ffmpeg_missing": "FFmpeg y ffprobe no est\u00e1n disponibles en este servidor. Instala el paquete ffmpeg en la VPS para procesar videos.",
